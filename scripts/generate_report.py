...
OUTPUT = os.path.join(PROJECT_ROOT, "report", "培养方案数据库系统_课程报告.docx")
...
r2 = p.add_run(
    ...
    '以西南财经大学2025版官方人才培养方案和上海财经大学公开培养方案为数据源，经过数据预处理与结构化，'
...
add_body(
    ...
    '上海财经大学数据来源于招生网和信息公开页面的培养方案信息，覆盖金融学、经济学、会计学3个专业。'
)
...
add_body(
    ...
    '官方PDF文件解决，上海财经大学PDF因字体编码问题无法提取文本，最终基于公开信息构建。'
